...
`time_factor` | factor by which to linearly scale time dependence for footprint smoothing; 0 to disable, defaults to 1
`distance_factor` | factor by which to linearly scale mean pairwise particle distance dependence for footprint smoothing; 0 to disable, defaults to 1
